package com.jasonpsanders.androidboilerplate.data.model;
...
public class Character implements Parcelable {
  ...
  public boolean equals(Object o) {
    ...
    if (mass != null ? !mass.equals(character.mass) : character.mass != null) {
      return false;
    }
    if (hairColor != null
    ...
    if (films != null ? !films.equals(character.films) : character.films != null) {
      return false;
    }
